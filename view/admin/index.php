...
session_start();
	echo '<script language="JavaScript">' .
		 'alert("Bem vindo");' .
		 'location.href="../galeria/index.php";' .
		 '</script>';
}
    ...
    <body>
		<div id='login'>
			<h2>Entrar no Sistema</h2>
				<div id='login_normal'>
					<form name='logar' id='logar' action='loginController.php' onsubmit='return verificarCampos("logar")' method='post'>
				...
				<div id='lembrete'>
					<form name='logar_lembrete' id='logar_lembrete' action='loginController.php' onsubmit='return verificarCampos("logar_lembrete")' method='post'>
