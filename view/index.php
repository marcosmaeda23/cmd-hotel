...
<div class="cf middleConteudo">
	...
	<div class="cadastro" style="padding-left:30px">
    	...
    	<form action="admin/homeController.php" method="post" style="border:0; margin:0;" id="cadastroUser"  class="formDefault"  onSubmit="return valida(this)" enctype="multipart/form-data" >
